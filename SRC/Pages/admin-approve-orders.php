...
<div class="container">
    ...
    <h3 class="p-2 head-style m-1"> New Orders Needs Approve</h3>
    <table class="table " style="min-height: 420px">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <a href="../model/removeOrder.php?oid=<?php echo $row["orderID"];?>" class="btn btn-danger mx-1">Decline</a>
                        <a href="../model/approveShippingOrder.php?oid=<?php echo $row["orderID"];?>" class="btn btn-success mx-1">Approve</a>
                    </div>
                </td>
            </tr>
        <?php } ?>
